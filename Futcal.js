...
const defaultSettings = {
    ...
    const teamDataApiUrl = encodeURI(`${baseApiUrl}/api/teams?id=${userSettings.teamId}&timezone=${userSettings.timeZone}`);
    ...
    //         dateFormatter.dateFormat = userSettings.showMatchesDayOfWeek ? "EEE dd/MMM" : "dd/MMM";    
                dateFormatter.dateFormat = userSettings.showMatchesDayOfWeek ? "MMM/dd EEE" : "MMM/dd";
